...
3. **Download a Compatible Preset:**
   *  The **[Megumin v5.0 Preset](https://github.com/Arif-salah/Megumin-Suite)** works perfectly with MVU compatiblity.
   * *Alternatively*, you can tet the **Izumi English Preset** from **[Discord](https://discord.com/invite/C6HabNwzn7)**.
4. **Play!** The MVU Stats Menu builder works seamlessly with the **[ArtificRealm Character Card](https://github.com/KritBlade/ArtificRealm)** , or just make your own MVU character card with your existing SillyTavern character card using **[MVU Game Maker](https://github.com/KritBlade/MVU_Game_Maker)**.
